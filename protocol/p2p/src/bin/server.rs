...
async fn main() {
    ...
    let adaptor = karlsen_p2p_lib::Adaptor::bidirectional(
        ip_port,
        karlsen_p2p_lib::Hub::new(),
        initializer,
        Default::default(),
    )
    .unwrap();
    ...
    for i in 0..1 {
        ...
        let _peer_key = adaptor
            .connect_peer_with_retries(ip_port.clone(), 16, Duration::from_secs(1))
            .await;
    }
