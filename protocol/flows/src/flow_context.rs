...
use karlsen_consensusmanager::{BlockProcessingBatch, ConsensusInstance, ConsensusManager, ConsensusProxy, ConsensusSessionOwned};
use karlsen_core::{
    debug, info,
...
impl ConnectionInitializer for FlowContext {
    async fn initialize_connection(&self, router: Arc<Router>) -> Result<(), ProtocolError> {
        ...
        // Before crescendo activation:
        //   - Accept connections from v5, v6, v7, and v8 peers
        //
        // Within 24h of crescendo activation:
        //   - Only accept v8 peers
        //   - Reject all older versions
        ...
        let connect_only_new_versions = self.config.crescendo_activation.is_active(sink_daa_score + daa_threshold);
