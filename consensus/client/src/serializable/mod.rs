//!
//! # Standardized JSON serialization and deserialization of Karlsen transactions.
//!
//! This module provides standardized JSON serialization and deserialization of
//! Karlsen transactions. There are two sub-modules: `numeric` and `string`.
//!
...
//! For more advanced use cases, please refer to `PSKT` in the [`karlsen_wallet_pskt`](https://docs.rs/karlsen_wallet_pskt)
//! crate.
//!
