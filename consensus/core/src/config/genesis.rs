...
pub const TESTNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0xa9, 0x91, 0xa2, 0xbf, 0x27, 0x1c, 0x1d, 0x2a,	0x7f, 0xc7, 0x63, 0x5d, 0x13, 0xaf, 0xef, 0x8f,
	    0x75, 0x2b, 0x1d, 0x89, 0xf9, 0x41, 0x4b, 0x87,	0xe0, 0x8d, 0x99, 0x84, 0xea, 0xf7, 0x42, 0xb2,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0x06, 0x8e, 0x09, 0xad, 0xab, 0x75, 0x3b, 0x8c,	0x0d, 0x91, 0x61, 0xb9, 0xde, 0x39, 0x5a, 0x4a,
	    0xa2, 0x38, 0xcb, 0xa8, 0x9b, 0xdc, 0x9b, 0x03, 0x67, 0xf6, 0xab, 0xdf, 0xe9, 0xd0, 0x0b, 0xe0,
    ]),
...
pub const SIMNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        0x8f, 0xe8, 0xb0, 0xf8, 0x04, 0x32, 0x52, 0xfd,	0xe9, 0x27, 0x09, 0x26, 0x33, 0x93, 0x79, 0x20,
	    0x94, 0x79, 0x5f, 0x34, 0x4e, 0xc2, 0x52, 0xc9,	0xb7, 0x56, 0xd1, 0xd1, 0x3e, 0x0d, 0xfe, 0x11,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0x04, 0xcf, 0x01, 0xcf, 0xc2, 0x9e, 0xce, 0x66,	0x55, 0x43, 0xd6, 0xbf, 0x5e, 0xc0, 0x99, 0x98,
	    0x8d, 0x4d, 0x3b, 0xaf, 0x19, 0xf2, 0x8f, 0xb0, 0xf9, 0xd4, 0xfa, 0xe3, 0x41, 0x20, 0x85, 0x17,
    ]),
    utxo_commitment: EMPTY_MUHASH,
    timestamp: 0x17c5f62fbb6,
    bits: 0x207fffff,
...
pub const DEVNET_GENESIS: GenesisBlock = GenesisBlock {
    hash: Hash::from_bytes([
        ...
        0xcb, 0x1b, 0x9e, 0x97, 0x2c, 0x04, 0x3e, 0xc9,	0x98, 0xc4, 0x36, 0x13, 0x46, 0x45, 0x04, 0xe1,
	    0x7d, 0xf2, 0xa4, 0x5a, 0x8a, 0x6a, 0xa1, 0x16,	0x21, 0xd9, 0x4b, 0x87, 0x6d, 0x69, 0xe0, 0xd4,
    ]),
    version: 0,
    hash_merkle_root: Hash::from_bytes([
        0x5e, 0xab, 0x60, 0xd4, 0xaa, 0x01, 0x02, 0x97,	0x8b, 0xc6, 0x8b, 0x43, 0xc5, 0x4d, 0x22, 0x8b,
	    0x71, 0x38, 0xa4, 0x20, 0x54, 0x48, 0x84, 0x31,	0x96, 0x7b, 0xc7, 0xaa, 0x86, 0x51, 0xb0, 0xe9,
    ]),
    utxo_commitment: EMPTY_MUHASH,
