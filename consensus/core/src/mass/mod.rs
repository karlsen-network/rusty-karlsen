...
// `karlsen_wallet_core::tx::mass::MassCalculator`
#[derive(Clone)]
        ...
        */
        let test_cases = vec![
            ...
            PluralityTestCase {
                ...
                outputs_tx2: &[200 * SOMPI_PER_KARLSEN, 400 * SOMPI_PER_KARLSEN],
                plurality_index: Some(1),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                ...
                inputs_tx2: &[1000 * SOMPI_PER_KARLSEN],
                outputs_tx2: &[400 * SOMPI_PER_KARLSEN],
                plurality_index: Some(0),
                desired_plurality: Some(2),
                override_output: true,
                storage_mass_parameter: 10_u64.pow(12),
            ...
            PluralityTestCase {
                ...
                outputs_tx1: &[
                    ...
                    200 * SOMPI_PER_KARLSEN,
                    400 * SOMPI_PER_KARLSEN,
                    250 * SOMPI_PER_KARLSEN,
                    250 * SOMPI_PER_KARLSEN,
                    250 * SOMPI_PER_KARLSEN,
                ],
                inputs_tx2: &[350 * SOMPI_PER_KARLSEN, 500 * SOMPI_PER_KARLSEN, 350 * SOMPI_PER_KARLSEN, 500 * SOMPI_PER_KARLSEN],
                outputs_tx2: &[200 * SOMPI_PER_KARLSEN, 200 * SOMPI_PER_KARLSEN, 400 * SOMPI_PER_KARLSEN, 750 * SOMPI_PER_KARLSEN],
