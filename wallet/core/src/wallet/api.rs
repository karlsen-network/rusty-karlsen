...
impl WalletApi for super::Wallet {
    ...
    async fn get_status_call(
        ...
        let (url, is_wrpc_client) = if let Some(wrpc_client) = self.try_wrpc_client() {
            (wrpc_client.url(), true)
        } else {
            (None, false)
        };
    ...
    async fn retain_context_call(
        self: Arc<Self>,
        request: RetainContextRequest,
    ) -> Result<RetainContextResponse> {
    ...
    async fn connect_call(self: Arc<Self>, request: ConnectRequest) -> Result<ConnectResponse> {
        ...
        if let Some(wrpc_client) = self.try_wrpc_client().as_ref() {
            ...
            let url = url
                .map(|url| {
                    wrpc_client
                        .parse_url_with_network_type(url, network_id.into())
    ...
    async fn change_network_id_call(
        self: Arc<Self>,
        request: ChangeNetworkIdRequest,
    ) -> Result<ChangeNetworkIdResponse> {
    ...
    async fn wallet_enumerate_call(
        self: Arc<Self>,
        _request: WalletEnumerateRequest,
    ) -> Result<WalletEnumerateResponse> {
        let wallet_descriptors = self.store().wallet_list().await?;
        Ok(WalletEnumerateResponse { wallet_descriptors })
    }

    async fn wallet_create_call(
        self: Arc<Self>,
        request: WalletCreateRequest,
    ) -> Result<WalletCreateResponse> {
        let WalletCreateRequest {
            wallet_secret,
            wallet_args,
        } = request;

        let (wallet_descriptor, storage_descriptor) =
            self.create_wallet(&wallet_secret, wallet_args).await?;
    ...
    async fn wallet_open_call(
        self: Arc<Self>,
        request: WalletOpenRequest,
    ) -> Result<WalletOpenResponse> {
        let WalletOpenRequest {
            wallet_secret,
            filename,
            account_descriptors,
            legacy_accounts,
        } = request;
        let args = WalletOpenArgs {
            account_descriptors,
            legacy_accounts: legacy_accounts.unwrap_or_default(),
        };
    ...
    async fn wallet_close_call(
        self: Arc<Self>,
        _request: WalletCloseRequest,
    ) -> Result<WalletCloseResponse> {
        self.close().await?;
        Ok(WalletCloseResponse {})
    }

    async fn wallet_reload_call(
        self: Arc<Self>,
        request: WalletReloadRequest,
    ) -> Result<WalletReloadResponse> {
    ...
    async fn wallet_rename_call(
        self: Arc<Self>,
        request: WalletRenameRequest,
    ) -> Result<WalletRenameResponse> {
        let WalletRenameRequest {
            wallet_secret,
            title,
            filename,
        } = request;
    ...
    async fn wallet_change_secret_call(
        self: Arc<Self>,
        request: WalletChangeSecretRequest,
    ) -> Result<WalletChangeSecretResponse> {
        let WalletChangeSecretRequest {
            old_wallet_secret,
            new_wallet_secret,
        } = request;
        self.store()
            .change_secret(&old_wallet_secret, &new_wallet_secret)
            .await?;
        Ok(WalletChangeSecretResponse {})
    }

    async fn wallet_export_call(
        self: Arc<Self>,
        request: WalletExportRequest,
    ) -> Result<WalletExportResponse> {
        let WalletExportRequest {
            wallet_secret,
            include_transactions,
        } = request;

        let options = storage::WalletExportOptions {
            include_transactions,
        };
    ...
    async fn wallet_import_call(
        self: Arc<Self>,
        request: WalletImportRequest,
    ) -> Result<WalletImportResponse> {
        let WalletImportRequest {
            wallet_secret,
            wallet_data,
        } = request;

        let wallet_descriptor = self
            .store()
            .wallet_import(&wallet_secret, &wallet_data)
            .await?;
    ...
    async fn prv_key_data_create_call(
        self: Arc<Self>,
        request: PrvKeyDataCreateRequest,
    ) -> Result<PrvKeyDataCreateResponse> {
        let PrvKeyDataCreateRequest {
            wallet_secret,
            prv_key_data_args,
        } = request;
    ...
    async fn prv_key_data_remove_call(
        self: Arc<Self>,
        _request: PrvKeyDataRemoveRequest,
    ) -> Result<PrvKeyDataRemoveResponse> {
        // TODO handle key removal
        return Err(Error::NotImplemented);
    }

    async fn prv_key_data_get_call(
        self: Arc<Self>,
        request: PrvKeyDataGetRequest,
    ) -> Result<PrvKeyDataGetResponse> {
        let PrvKeyDataGetRequest {
            prv_key_data_id,
            wallet_secret,
        } = request;
    ...
    async fn accounts_rename_call(
        self: Arc<Self>,
        request: AccountsRenameRequest,
    ) -> Result<AccountsRenameResponse> {
        let AccountsRenameRequest {
            account_id,
            name,
            wallet_secret,
        } = request;
    ...
    async fn accounts_select_call(
        self: Arc<Self>,
        request: AccountsSelectRequest,
    ) -> Result<AccountsSelectResponse> {
    ...
    async fn accounts_enumerate_call(
        self: Arc<Self>,
        _request: AccountsEnumerateRequest,
    ) -> Result<AccountsEnumerateResponse> {
        ...
        Ok(AccountsEnumerateResponse {
            account_descriptors,
        })
    }

    async fn accounts_activate_call(
        self: Arc<Self>,
        request: AccountsActivateRequest,
    ) -> Result<AccountsActivateResponse> {
    ...
    async fn accounts_deactivate_call(
        self: Arc<Self>,
        request: AccountsDeactivateRequest,
    ) -> Result<AccountsDeactivateResponse> {
    ...
    async fn accounts_discovery_call(
        self: Arc<Self>,
        request: AccountsDiscoveryRequest,
    ) -> Result<AccountsDiscoveryResponse> {
        let AccountsDiscoveryRequest {
            discovery_kind: _,
            address_scan_extent,
            account_scan_extent,
            bip39_passphrase,
        ...
        let last_account_index_found = self
            .scan_bip44_accounts(
                bip39_mnemonic,
                bip39_passphrase,
                address_scan_extent,
        ...
        Ok(AccountsDiscoveryResponse {
            last_account_index_found,
        })
    }

    async fn accounts_create_call(
        self: Arc<Self>,
        ...
        let account = self
            .create_account(&wallet_secret, account_create_args, true)
            .await?;
    ...
    async fn accounts_ensure_default_call(
        ...
        let AccountsEnsureDefaultRequest {
            wallet_secret,
            payment_secret,
            account_kind,
            mnemonic_phrase,
        ...
        let account_descriptor = self
            .ensure_default_account_impl(
                &wallet_secret,
                payment_secret.as_ref(),
                account_kind,
                mnemonic_phrase.as_ref(),
            )
            .await?;
    ...
    async fn accounts_import_call(
        self: Arc<Self>,
        _request: AccountsImportRequest,
    ) -> Result<AccountsImportResponse> {
        // TODO handle account imports
        return Err(Error::NotImplemented);
    }

    async fn accounts_get_call(
        self: Arc<Self>,
    ...
    async fn accounts_send_call(
        self: Arc<Self>,
        request: AccountsSendRequest,
    ) -> Result<AccountsSendResponse> {
    ...
    async fn accounts_transfer_call(
        self: Arc<Self>,
        request: AccountsTransferRequest,
    ) -> Result<AccountsTransferResponse> {
        ...
        let source_account = self
            .get_account_by_id(&source_account_id)
            .await?
            .ok_or(Error::AccountNotFound(source_account_id))?;
    ...
    async fn accounts_estimate_call(
        self: Arc<Self>,
        request: AccountsEstimateRequest,
    ) -> Result<AccountsEstimateResponse> {
        let AccountsEstimateRequest {
            account_id,
            destination,
            priority_fee_sompi,
            payload,
        ...
        if let Some(abortable) = self
            .inner
            .estimation_abortables
            .lock()
            .unwrap()
            .get(&account_id)
        {
        ...
        self.inner
            ...
            .lock()
            .unwrap()
            .insert(account_id, abortable.clone());
        let result = account
            .estimate(destination, priority_fee_sompi, payload, &abortable)
            .await;
        self.inner
            .estimation_abortables
            .lock()
        ...
        Ok(AccountsEstimateResponse {
            generator_summary: result?,
        })
    }

    async fn transactions_data_get_call(
        self: Arc<Self>,
        request: TransactionsDataGetRequest,
    ) -> Result<TransactionsDataGetResponse> {
        let TransactionsDataGetRequest {
            account_id,
            network_id,
            filter,
            start,
        ...
        let TransactionRangeResult {
            transactions,
            total,
        } = store
            .load_range(&binding, &network_id, filter, start as usize..end as usize)
            .await?;

        Ok(TransactionsDataGetResponse {
            transactions,
            total,
            account_id,
            start,
    ...
    async fn transactions_replace_note_call(
        ...
        let TransactionsReplaceNoteRequest {
            account_id,
            network_id,
            transaction_id,
            note,
    ...
    async fn transactions_replace_metadata_call(
        ...
        let TransactionsReplaceMetadataRequest {
            account_id,
            network_id,
            transaction_id,
            metadata,
