...
//!
//! This module contains a Rust implementation of the Karlsen wallet that
...
use karlsen_wallet_keys::xpub::NetworkTaggedXpub;
...
impl Wallet {
    ...
    pub fn wrpc_client(&self) -> Arc<KarlsenRpcClient> {
        self.try_rpc_api().and_then(|api| api.clone().downcast_arc::<KarlsenRpcClient>().ok()).unwrap()
    }
