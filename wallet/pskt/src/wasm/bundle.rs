...
use crate::wasm::pskt::*;
use crate::wasm::utils::sompi_to_karlsen_string_with_suffix;
use karlsen_consensus_core::network::{NetworkId, NetworkIdT};
...
impl PSKB {
    ...
    pub fn display_format(&self, network_id: &NetworkIdT) -> Result<String> {
        ...
        Ok(self.0.display_format(network_id, sompi_to_karlsen_string_with_suffix))
    }
