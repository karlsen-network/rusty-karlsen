...
use karlsen_txscript::{extract_script_pub_key_address, pay_to_address_script, pay_to_script_hash_script};
...
pub fn script_sig_to_address(script_sig: &[u8], prefix: karlsen_addresses::Prefix) -> Result<Address, Error> {
...
mod tests {
    ...
    use crate::role::*;
    use karlsen_consensus_core::tx::{TransactionId, TransactionOutpoint, UtxoEntry};
    use karlsen_txscript::{multisig_redeem_script, pay_to_script_hash_script};
