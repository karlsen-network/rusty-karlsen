//!
//! Partially Signed Karlsen Transaction (PSKT)
//!

use karlsen_bip32::{secp256k1, DerivationPath, KeyFingerprint};
use karlsen_consensus_core::{hashing::sighash::SigHashReusedValuesUnsync, Hash};
...
use karlsen_consensus_core::mass::{MassCalculator, NonContextualMasses};
...
///
/// A Partially Signed Karlsen Transaction (PSKT) is a standardized format
/// that allows multiple participants to collaborate in creating and signing
/// a Karlsen transaction. PSKT enables the exchange of incomplete transaction
