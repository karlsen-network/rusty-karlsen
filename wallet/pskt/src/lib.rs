//!
//! PSKT is a crate for working with Partially Signed Karlsen Transactions (PSKTs).
...
//! multiple `PSKT` instances allowing for exchange of Karlsen sweep transactions.
//!
