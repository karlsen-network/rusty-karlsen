...
impl MiningManager {
    ...
    pub(crate) fn get_realtime_feerate_estimations_verbose(
        ...
        {
            let script_public_key = karlsen_txscript::pay_to_address_script(&karlsen_addresses::Address::new(
                prefix,
            ...
            let BlockTemplate { block: karlsen_consensus_core::block::MutableBlock { transactions, .. }, calculated_fees, .. } =
